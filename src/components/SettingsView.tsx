    ...
    <div className="space-y-8 pb-12 max-w-4xl font-['Inter']">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs shadow-sm transition-all"
        >
          {savedSuccess ? (
            <>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-5">
        <div className="flex items-center justify-between">
          ...
          {rzpStatus?.connected ? (
            ...
            <span className="flex items-center gap-1.5 text-xs font-semibold text-slate-600 bg-slate-100 px-3 py-1 rounded-full border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white text-xs font-mono border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-lg transition flex items-center gap-1.5 shadow-sm disabled:opacity-50"
              >
                {isTestingRzp ? (
                  <>
              ...
              {rzpStatus?.connected && (
                <button
                  ...
                  className="px-3.5 py-2 bg-white border border-slate-300 hover:bg-slate-100 text-slate-700 text-xs font-medium rounded-lg transition"
                >
                  Disconnect
                </button>
              )}
            ...
            <div className="text-[11px] text-slate-500">
              Environment: <strong className="text-slate-800 uppercase font-mono">Test Mode</strong> (Safe for testing)
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-3.5 border border-slate-200 rounded-xl space-y-2">
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs font-semibold text-slate-800 focus:outline-none focus:ring-1 focus:ring-slate-900"
              >
          ...
          <div className="p-3.5 border border-slate-200 rounded-xl space-y-2">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs font-bold font-['JetBrains_Mono'] text-slate-900 focus:outline-none focus:ring-1 focus:ring-slate-900"
              />
            </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-5">
        ...
        <div className="space-y-4 pt-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3.5 border border-slate-200 rounded-xl space-y-2">
              <label className="text-xs font-bold text-slate-900 block">Quiet Hours Start</label>
              <select
                value={quietStart}
            ...
            <div className="p-3.5 border border-slate-200 rounded-xl space-y-2">
              <label className="text-xs font-bold text-slate-900 block">Quiet Hours End</label>
              <select
                value={quietEnd}
